/*
Script Name: ExtractSirName
Description:
"Extracts the Sir name from the clipboard content. The clipboard may contain a string in the format 'given, (middle) last (suffix)', with at least the given and last names present. The script then sends the sir name to the active window."
...
TraySetIcon A_ScriptDir "\icons\knight.png"
